...
namespace TrackerLibrary.DataAccess.TextHelpers
{
    public static class TextConnectorProcessor
    {
        ...
        public static List<TournamentModel> ConvertToTournamentModels(this List<string> lines, string peopleFileName, string teamFileName, string prizesFileName)
        {
            ...
            foreach (string line in lines)
            {
                ...
                tm.EnteredTeams = new List<TeamModel>();
        ...
        {
            // 0 id, 1 TeamCompeting, 2 Score, 3 ParentMatchup
